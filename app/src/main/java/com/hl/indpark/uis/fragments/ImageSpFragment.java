...
import com.hl.indpark.uis.activities.EventSpActivity;
 ...
 */
public class ImageSpFragment extends BaseFragment {
    private EventSpActivity activity;
    ...
    public void setActivity(EventSpActivity homeActivity, List<String> data) {
