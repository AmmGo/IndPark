...
public class SignInActivity extends BaseActivity implements LocationSource, AMapLocationListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        titleBar.getCenterTextView().setText("签到打卡");
...
//                        ToastUtil.showToastLong(this,"打卡成功");
//                    } else {
    ...
    public void getSignIn(String lon,String lat) {
        ArticlesRepo.getSignIn(lon,lat).observe(this, new ApiObserver<String>() {
            ...
            public void onSuccess(Response<String> response) {
                ToastUtil.showToast(SignInActivity.this, "打卡成功");
            }
            @Override
        ...
        switch (requestCode) {
            ...
            case WRITE_COARSE_LOCATION_REQUEST_CODE:
                if (grantResults.length > 0
                    ...
                    // 没有获取到权限，做特殊处理
                    ToastUtil.showToastLong(this,"获取位置权限失败，请手动开启");
                }
                break;
            default:
                break;
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    btn_check_in.setText(String.format("签到打卡\n%s", sysTimeStr)); // 实时更新时间
