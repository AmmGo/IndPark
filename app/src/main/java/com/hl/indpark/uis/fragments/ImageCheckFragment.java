...
import com.hl.indpark.uis.activities.SelfCheckIdActivity;
...
public class ImageCheckFragment extends BaseFragment {
    private SelfCheckIdActivity activity;
    ...
    public void setActivity(SelfCheckIdActivity homeActivity, List<String> data) {
