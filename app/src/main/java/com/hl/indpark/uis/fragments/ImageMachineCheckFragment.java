...
import com.hl.indpark.uis.activities.MachineCheckIdActivity;
 ...
 */
public class ImageMachineCheckFragment extends BaseFragment {
    private MachineCheckIdActivity activity;
    ...
    public void setActivity(MachineCheckIdActivity homeActivity, List<String> data) {
