...
public class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置显示动画
        window.setWindowAnimations(R.style.photo_dialog__animstyle);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.primary_dark);
                mOtherItemColor = mActivity.getResources().getColor(R.color.primary_dark);
            }
            if (1 == mStrings.size()) {
